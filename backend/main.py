...
# Without this middleware, `limiter.default_limits` is configured but never
# enforced — slowapi only checks limits from here or from a per-route
# @limiter.limit(...) decorator, neither of which existed before.
